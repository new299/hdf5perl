...
$status	= Hdf5::H5Dwrite($dataset,$Hdf5::H5T_NATIVE_INT,$Hdf5::H5S_ALL,$Hdf5::H5S_ALL,$Hdf5::H5P_DEFAULT,\@datain);
...
$status    = Hdf5::H5Dread($dataset,$Hdf5::H5T_NATIVE_INT,$Hdf5::H5S_ALL,$Hdf5::H5S_ALL,$Hdf5::H5P_DEFAULT,\@dataout);
