...
#     AUTHOR => [q[new@sgenomics.co.uk]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     DEFINE => q[]
#     INC => q[-I. -I/home/user/hdf5/include]
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/OXFORDNANOLABS/cwright/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
INC = -I. -I/home/user/hdf5/include
DEFINE = 
...
TO_INST_PM = lib/Hdf5.pm \
	lib/Hdf5/File.pm

PM_TO_BLIB = lib/Hdf5.pm \
	blib/lib/Hdf5.pm \
	lib/Hdf5/File.pm \
	blib/lib/Hdf5/File.pm
...
LDLOADLIBS = -lhdf5 -lz
BSLOADLIBS = 
LD_RUN_PATH = /usr/lib/../lib:/lib/x86_64-linux-gnu
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  ...
	  lib/Hdf5/File.pm $(INST_MAN3DIR)/Hdf5::File.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(LIB_EXT) core \
	  Hdf5.c $(INST_ARCHAUTODIR)/extralibs.all \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Hdf5 reader perl extension'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - new@sgenomics.co.uk' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Hdf5 reader perl extension",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "new@sgenomics.co.uk"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Hdf5 reader perl extension</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>new@sgenomics.co.uk</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  lib/Hdf5/File.pm blib/lib/Hdf5/File.pm 
